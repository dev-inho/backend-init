...
/**
 * JPA 저장소 모듈을 단독으로 사용할 때도 검증이 수행되도록 독자적으로 구성된 검증 자동 구성 클래스입니다.
 *
 * MyBatis 모듈과 중복될 수 있으나, 공통 코어 모듈이 없으므로 각각의 Starter가 독립적인 classpath 안전성을
 ...
 */
@AutoConfiguration
class JpaProviderValidationAutoConfiguration {

    companion object {
        @Bean
        @JvmStatic
        fun jpaProviderValidationBeanFactoryPostProcessor(): BeanFactoryPostProcessor {
